...
java -jar bundles\com.kony.studio.viz.core.win64\konywebstudio\lib\mf\mfcli.jar native-publish -u v.pavithra@hcl.com -p Pavithra@19 -t 100037194 -clurl https://manage.kony.com/ -a Uploadapp -v 1.0 -e "VoltMX Technohub" -cbmeta "{"android_phone" : 1.0.0}"